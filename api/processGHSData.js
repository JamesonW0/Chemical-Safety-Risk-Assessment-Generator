...
const FORM_TEMPLATE_PATH = path.join(__dirname, "..", "resourses", "COSHH_Form_Template.docx");
const TICKS_TEMPLATE_PATH = path.join(__dirname, "..", "resourses", "COSHH_Ticks_Template.docx");
